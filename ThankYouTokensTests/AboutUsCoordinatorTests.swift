...
class AboutUsCoordinatorTests: XCTestCase {

    let coord = AboutUsCoordinator(navigationController: UINavigationController())
    ...
    func test_check_home_viewcontroller() {
        coord.start()
        XCTAssertTrue(coord.navigationController.topViewController is AboutUsViewController)
    }
