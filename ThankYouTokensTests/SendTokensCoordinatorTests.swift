//
//  SendTokensCoordinatorTests.swift
//  ThankYouTokensTests
//
...
class SendTokensCoordinatorTests: XCTestCase {

    let coord = SendTokensCoordinator(navigationController: UINavigationController())
    ...
    func test_check_home_viewcontroller() {
        coord.start()
        XCTAssertTrue(coord.navigationController.topViewController is SendTokensViewController)
    }
